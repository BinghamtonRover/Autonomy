...
class RoverGps extends GpsInterface {
  final _latitudeCorrector = ErrorCorrector(maxDeviation: GpsInterface.gpsError * 10);
  final _longitudeCorrector = ErrorCorrector(maxDeviation: GpsInterface.gpsError * 10);
